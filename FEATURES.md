...
### §5.4 执行器 SPI · 4✅ · `↗ 内置实现/选择/生命周期见 §2.3`
- ✅ **ExecutionBackend SPI（add_runner；替代 runner）** — runtime_checkable 协议；内置 Local + Subprocess；pick_runner 按名字选、run_index 路由。 `kernel/hub/backends.py:43-62; deps.py:228 pick_runner, 198 run_index`
