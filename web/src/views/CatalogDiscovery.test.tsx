...
describe('Catalog discovery request and mutation truth', () => {
  ...
  it('keeps v3 facts revision-bound while preview advances, then refreshes exact v4 facts', async () => {
    ...
    // Head facts load automatically; a fresh detail never opens on the stale-facts banner.
    ...
    // The preview fence advances the head to v4; the automatic follow-up refresh fails, so the
    // banner reports confirmed drift with the retry control.
