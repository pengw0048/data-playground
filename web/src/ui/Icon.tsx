...
const P: Record<IconName, JSX.Element> = {
  ...
  star: <path d="M8 1.8 9.7 5.7 14 6.2 10.8 9.1 11.7 13.4 8 11.2 4.3 13.4 5.2 9.1 2 6.2 6.3 5.7Z" />,
...
export function Icon({ name, size = 14, style, strokeWidth = 1.4, filled = false }: {
  ...
  const solid = name === 'play' || name === 'sparkle' || (name === 'star' && filled) || (filled && name === 'stop')
  return (
    <svg
      width={size}
      height={size}
