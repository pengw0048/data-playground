...
class APIErrorCode(StrEnum):
    ...
    MEDIA_CELL_IDENTITY_UNAVAILABLE = "media_cell_identity_unavailable"
    MEDIA_CELL_IDENTITY_INVALID = "media_cell_identity_invalid"
    MEDIA_CELL_ROW_NOT_FOUND = "media_cell_row_not_found"
    MEDIA_CELL_ROW_AMBIGUOUS = "media_cell_row_ambiguous"
    MEDIA_CELL_UNSUPPORTED = "media_cell_unsupported"
